...
<a href='#' onclick = 'next(1)' class="right"><img src="./images/right.svg" alt=""></a>
<a href='#' onclick = 'next(-1)' class="left"><img src="./images/left.svg" alt=""></a>
...
// this function is associates with onclick of each dot. It takes inpuo(1,2,or 3, depending on which dot is clicked)
...
// another issue I just fount - left arrow disappears from the screen for some reason while right one stays
